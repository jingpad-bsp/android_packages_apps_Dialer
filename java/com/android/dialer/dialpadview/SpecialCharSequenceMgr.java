...
public class SpecialCharSequenceMgr {
  ...
  private static final String MMI1 = "*#37*#";//add 20130909
  private static final String MMI2 = "*#38*#";//add 20130909
  private static final String MMI2_380 = "*#380*#";//add 20130909
  /**
  ...
  public static boolean handleChars(Context context, String input, EditText textField) {
    ...
    if (handleDeviceIdDisplay(context, dialString)
		...
		|| handleValidationTools(context, dialString)
		|| handleValidationToolsMMI2(context, dialString)
        || handleValidationToolsMMI2_380(context, dialString)
    ...
    /* UNISOC: Operator nck simlock @{ */
    if (context != null && context.getResources().getBoolean(com.android.internal.R.bool.config_operator_nck_simlock)
            && input.length() > 10 && !input.startsWith("*#*#")
            && input.startsWith("*#") && input.endsWith("#")) {
        String secretCode = input.replaceAll("\\D", "");
...
static boolean handleValidationTools(Context context, String input){
    if(input.equals(MMI1))
    {
 ...
 static boolean handleValidationToolsMMI2(Context context, String input){
    if(input.equals(MMI2))
    {
		ComponentName cn = new ComponentName("com.sprd.validationtools","com.android.adb.Custom2ValidationMainActivity");
		Intent intent = new Intent() ;
		intent.setComponent(cn) ;
		context.startActivity(intent) ;
	return true;
  ...
  static boolean handleValidationToolsMMI2_380(Context context, String input){
    if(input.equals(MMI2_380))
    {
      ComponentName cn = new ComponentName("com.sprd.validationtools","com.android.adb.CustomValidationMainActivity");
      Intent intent = new Intent() ;
      intent.setComponent(cn) ;
      context.startActivity(intent) ;
      return true;
