...
public class MainSearchController implements SearchBarListener {
  ...
  public boolean onMenuItemClicked(MenuItem menuItem) {
    if (menuItem.getItemId() == R.id.settings) {
      if (!PermissionsUtil.hasReadPhoneStatePermissions(activity)) {
      	Toast.makeText(activity, R.string.permission_no_call_settings, Toast.LENGTH_SHORT).show();
      } else {
