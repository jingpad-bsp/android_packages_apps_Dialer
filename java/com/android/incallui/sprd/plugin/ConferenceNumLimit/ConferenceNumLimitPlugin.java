...
/**
 *  UNISOC Feature Porting: Toast information when the number of conference call is over limit for cmcc case
 */
public class ConferenceNumLimitPlugin extends ConferenceNumLimitHelper{
    ...
    /* UNISOC: Toast information when the number of conference call is over limit for cmcc case @{ */
    public boolean showMergeButton(DialerCall call) {
        ...
        //UNISOC: add for bug1381374
        return mConferenceSize < MAX_CONFERENCE_NUMS ? call.can(
                android.telecom.Call.Details.CAPABILITY_MERGE_CONFERENCE) :
                (mBackgroundCall != null && call.getState() == DialerCallState.ACTIVE);
    }
