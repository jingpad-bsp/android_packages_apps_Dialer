...
public class ContactGridManager {
  ...
  private void updatePrimaryNameAndPhoto() {
    if (TextUtils.isEmpty(primaryInfo.name())) {
      ...
      if (call != null && call.isEmergencyCall()) {
        ...
        contactNameTextView.setText(textE+" "+PhoneNumberUtils.createTtsSpannable(call.getNumber()));
      } else {
  ...
  private boolean isShowNameAndNumber(DialerCall call) {
    return ((InCallUiUtils.ShowShowNumberAndName(context, call) )|| (call!=null&&call.isVideoCall()))
