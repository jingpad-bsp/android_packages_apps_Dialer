...
public class InCallPresenter implements CallList.Listener, AudioModeProvider.AudioModeListener {
  ...
  public void onIncomingCall(DialerCall call) {
    ...
    //UNISOC:add for bug1464840
    if (inCallActivity != null && inCallActivity.isFinishing()) {
      LogUtil.i("InCallPresenter.onIncomingCall","before inCallActivity has not destroy");
      updateActivity(null);
    }
  ...
  private void setDisconnectCauseForMissingAccounts(DialerCall call) {
    ...
    if ((phoneAccountHandles == null || phoneAccountHandles.isEmpty())
            // UNISOC: add for bug1381310
            && call != null && call.getHandle() != null) {
